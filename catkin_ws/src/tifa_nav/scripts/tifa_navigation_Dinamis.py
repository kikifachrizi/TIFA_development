...
def callback(msg):
    ...
    # if current_setpoint_index < target_setpoint_index:
    #     # Bergerak maju berurutan
    #     if not processing_setpoint:
    #         rospy.loginfo("Menuju index %d dari %d", target_setpoint_index, current_setpoint_index)
    ...
    # elif current_setpoint_index > target_setpoint_index:
    #     # Bergerak mundur berurutan (jika diperlukan)
    #     if not processing_setpoint:
    #         rospy.loginfo("Menuju index %d dari %d", target_setpoint_index, current_setpoint_index)
    #         processing_setpoint = True
    ...
    #         processing_setpoint = False
    # else:
    #     rospy.loginfo("Sampai di tujuan index %d", current_setpoint_index)
    #     executing_sequence = False
...
def update_target_point(msg):
    ...
    print(type(msg.point.x))
    current_target.append[int(msg.point.x), int(msg.point.y), int(0.0)]
